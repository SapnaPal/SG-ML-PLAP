...
model = joblib.load('ecif_vina_redocked_prediction_gbt_model.sav')
...
#df.index = ['Predicted binding affinity(-log(Kd/Ki)']
print(df)
df.to_csv('ECIF_VINA_redocked_trained_gbt_prediction.csv')
